        ...
        for (int i = 1; i <= 7; i++)
        {
            ...
            if (newRow >= 0 && newRow <= 7 && newCol >= 0 && newCol <= 7)
            {
                ...
                if (!pathBlocked)
                {
                    ...
                    {
                        if(upLeft.getOccupyingPiece().getColor() != this.getColor())
                        {
                            moves.add(upLeft);
                            pathBlocked = true;
                        }
        ...
        for (int i = 1; i <= 7; i++)
        {
            ...
            if (newRow >= 0 && newRow <= 7 && newCol >= 0 && newCol <= 7)
            {
                ...
                if (!pathBlocked)
                {
                    ...
                    {
                        if(downRight.getOccupyingPiece().getColor() != this.getColor())
                        {
                            moves.add(downRight);
                            pathBlocked = true;
                        }
        ...
        for (int i = 1; i <= 7; i++)
        {
            ...
            if (newRow >= 0 && newRow <= 7 && newCol >= 0 && newCol <= 7)
            {
                ...
                if (!pathBlocked)
                {
                    ...
                    {
                        if(downLeft.getOccupyingPiece().getColor() != this.getColor())
                        {
                            moves.add(downLeft);
                            pathBlocked = true;
                        }
